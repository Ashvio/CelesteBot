...
public static class SimplifiedGraphicsFeature
{
    ...
    private static bool lastSimplifiedGraphics = CelesteBotInteropModule.Settings.SimplifiedGraphics;
    ...
    private static bool IsSimplifiedGraphics() => CelesteBotInteropModule.Settings.SimplifiedGraphics;

    private static bool IsSimplifiedParticle() => CelesteBotInteropModule.Settings.SimplifiedGraphics;

    private static bool IsSimplifiedDistort() => CelesteBotInteropModule.Settings.SimplifiedGraphics;

    private static bool IsSimplifiedDecal() => CelesteBotInteropModule.Settings.SimplifiedGraphics;

    private static bool IsSimplifiedMiniTextbox() => CelesteBotInteropModule.Settings.SimplifiedGraphics;

    private static bool SimplifiedWavedBlock() => CelesteBotInteropModule.Settings.SimplifiedGraphics;

    private static ScreenWipe SimplifiedScreenWipe(ScreenWipe wipe) => null;

    private static bool IsSimplifiedLightningStrike() => CelesteBotInteropModule.Settings.SimplifiedGraphics;

    private static bool IsSimplifiedClutteredEntity() => CelesteBotInteropModule.Settings.SimplifiedGraphics;

    private static bool IsSimplifiedHud()
    {
        return CelesteBotInteropModule.Settings.SimplifiedGraphics ;
    }
    ...
    {
        return CelesteBotInteropModule.Settings.SimplifiedGraphics 
            ? (10 - CelesteBotInteropModule.Settings.SimplifiedLighting.Value) / 10f
            : alpha;
    }
        ...
        MTexture toTex, float p)
    {
        ...
        if (CelesteBotInteropModule.Settings.SimplifiedGraphics )
        {
    ...
    {
        return CelesteBotInteropModule.Settings.SimplifiedGraphics 
            ? CelesteBotInteropModule.Settings.SimplifiedBloomBase.Value / 10f
            : bloomValue;
    }
    ...
    {
        return CelesteBotInteropModule.Settings.SimplifiedGraphics 
            ? CelesteBotInteropModule.Settings.SimplifiedBloomStrength.Value / 10f
            : bloomValue;
    }
    ...
    {
        return CelesteBotInteropModule.Settings.SimplifiedGraphics  ? null : effect;
    }
    ...
    {
        if (CelesteBotInteropModule.Settings.SimplifiedGraphics && CelesteBotInteropModule.Settings.SimplifiedSolidTilesStyle != default)
        {
            currentSolidTilesStyle = CelesteBotInteropModule.Settings.SimplifiedSolidTilesStyle;
        }
        else
        {
        ...
        Rectangle forceFill, char forceId, Autotiler.Behaviour behaviour)
    {
        ...
        if (creatingSolidTiles && CelesteBotInteropModule.Settings.SimplifiedGraphics && CelesteBotInteropModule.Settings.SimplifiedSolidTilesStyle != default && !default(char).Equals(tile) &&
            tile != '0')
        {
            return CelesteBotInteropModule.Settings.SimplifiedSolidTilesStyle.Value;
        }
        else
        {
            return tile;
    ...
    {
        if (self is BackgroundTiles && CelesteBotInteropModule.Settings.SimplifiedGraphics)
        {
            return;
        }
    ...
    {
        return CelesteBotInteropModule.Settings.SimplifiedGraphics && CelesteBotInteropModule.Settings.SimplifiedSpinnerColor.Name == CrystalColor.Rainbow ? Color.White : color;
    }
    ...
    private static void LightningRenderer_RenderIL(ILContext il)
    {
        ...
        {
            c.EmitDelegate<Func<bool, bool>>(drawEdges => (!CelesteBotInteropModule.Settings.SimplifiedGraphics) && drawEdges);
        }
    }
    ...
    {
        return CelesteBotInteropModule.Settings.SimplifiedGraphics && CelesteBotInteropModule.Settings.SimplifiedSpinnerColor.Value != null
            ? CelesteBotInteropModule.Settings.SimplifiedSpinnerColor.Value
            : color;
    }
    ...
    {
        return CelesteBotInteropModule.Settings.SimplifiedSpinnerColor.Color;
    }
